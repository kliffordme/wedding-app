...
export default function HorizontalGallery() {
  ...
  return (
    <section ref={sectionRef} className="overflow-hidden bg-ivory">
      ...
      {/* Scrolling strip — top padding gives breathing room from the label */}
      <div ref={stripRef} className="flex flex-nowrap will-change-transform pt-20">
        {IMAGES.map(({ src, alt }) => (
          <div
            key={src}
            className="flex-shrink-0 w-[80vw] md:w-[38vw] lg:w-[30vw] px-3 md:px-5 pb-12 box-content"
          >
            <div className="relative w-full aspect-[3/4] overflow-hidden">
              <Image
                ...
                sizes="(max-width: 768px) 80vw, (max-width: 1024px) 38vw, 30vw"
              />
            </div>
          </div>
        ))}
